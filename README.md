...
```
docker build -t savings/a .
```
Check the image is build successfully
```
docker images

savings/a    latest         eff3e9573427   18 hours ago   151MB
```
Run the image
```
docker run --rm -d -v /home/users/logs:/logs -p 8081:8081 --name savings-a savings/a
```
Check the container started
```
docker ps

cc16d82c240d   savings/a         "java -Djava.securit…"   4 seconds ago    Up 3 seconds    0.0.0.0:8081->8081/tcp   savings-a
```
